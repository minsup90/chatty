...
public class MessageObject {
    ...
    public MessageObject(TLRPC.Message message, AbstractMap<Integer, TLRPC.User> users, boolean generateLayout) {
        if (textPaint == null) {
            ...
            // 글씨컬러
            textPaint.setColor(0xff11611f);
            // 링크컬러
            textPaint.linkColor = 0xff776f9f;
        }
        ...
        if (message instanceof TLRPC.TL_messageService) {
            if (message.action != null) {
                ...
                if (message.action instanceof TLRPC.TL_messageActionChatCreate) {
                    if (isOut()) {
                        // ActionYouCreateGroup: "그룹을 만들었습니다."
                        messageText = LocaleController.getString("ActionYouCreateGroup", R.string.ActionYouCreateGroup);
                    } else {
                        // ActionCreateGroup: "un1님이 그룹을 만들었습니다."
                        if (fromUser != null) {
                    ...
                    if (message.action.user_id == message.from_id) {
                        if (isOut()) {
                            // ActionYouLeftUser : "그룹을 떠났습니다"
                            messageText = LocaleController.getString("ActionYouLeftUser", R.string.ActionYouLeftUser);
                        } else {
                            if (fromUser != null) {
                                // ActionLeftUser : "OO님이 퇴장했습니다"
                        ...
                        if (whoUser != null && fromUser != null) {
                            if (isOut()) {
                                // fromUser = 갑, whoUser = 을
                                // ActionYouKickUser : "un2님을 추방했습니다"
                    ...
                    if (fromUser != null) {
                        if (isOut()) {
                            // ActionInviteYou : "초대링크를 타고 그룹에 참여하였습니다."
                            messageText = LocaleController.getString("ActionInviteYou", R.string.ActionInviteYou);
                        } else {
                            // ActionInviteUser : "초대링크를 타고 그룹에 un1님이 참여하였습니다."
                    ...
                    if (isOut()) {
                        // ActionYouChangedPhoto : "그룹 사진을 변경했습니다"
                        messageText = LocaleController.getString("ActionYouChangedPhoto", R.string.ActionYouChangedPhoto);
                    } else {
                        if (fromUser != null) {
                            // ActionChangedPhoto : "un1님이 그룹 사진을 변경했습니다"
                    ...
                    if (isOut()) {
                        // ActionYouChangedTitle : "그룹 이름을 un2 그룹으로 변경했습니다"
                        ...
                        if (fromUser != null) {
                            // ActionChangedTitle : "un1님이 그룹 이름을 un2 그룹으로 변경했습니다"
                    ...
                    if (isOut()) {
                        // ActionYouRemovedPhoto : "그룹 사진을 삭제했습니다"
                        messageText = LocaleController.getString("ActionYouRemovedPhoto", R.string.ActionYouRemovedPhoto);
                    } else {
                        if (fromUser != null) {
                            // ActionRemovedPhoto : "un1님이 그룹 사진을 삭제했습니다"
                    ...
                    if (message.action.ttl != 0) {
                        if (isOut()) {
                            // MessageLifetimeChangedOutgoing : "자동삭제를 %1$s 후로 설정했습니다"
                            ...
                            if (fromUser != null) {
                                // MessageLifetimeChanged : "%1$s님이 자동삭제를 %2$s 후로 설정했습니다"
                        ...
                        if (isOut()) {
                            // MessageLifetimeYouRemoved : "자동삭제를 해제했습니다"
                            messageText = LocaleController.getString("MessageLifetimeYouRemoved", R.string.MessageLifetimeYouRemoved);
                        } else {
                            if (fromUser != null) {
                                // MessageLifetimeRemoved : "%1$s님이 자동삭제를 해제했습니다"
                    ...
                    if (fromUser != null) {
                        // NotificationContactJoined : "%1$s님이 텔레그램에 가입했습니다!"
                    ...
                    if (fromUser != null) {
                        // NotificationContactNewPhoto : "%1$s님이 프로필 사진을 변경했습니다"
                    ...
                    // YouCreatedBroadcastList : "단체 메시지 리스트를 만들었습니다"
            ...
            if (message.media instanceof TLRPC.TL_messageMediaPhoto) {
                ...
                // UnsuppotedMedia: "이 메시지는 현재 사용 중인 버전의 Telegram에서 지원되지 않습니다. 메시지를 보려면 https://telegram.org/update 에서 앱을 업데이트하세요."
                messageText = LocaleController.getString("UnsuppotedMedia", R.string.UnsuppotedMedia);
            }
            // 음악과 스티커는 messageMediaDocument
